...
<?php
 ...
 $menuItems[] = ['label' => Yii::t('user', 'Profile details'), 'url' => ['/user/admin/update-profile', 'id' => $user->id]];
 
 $session = Yii::$app->session;
 $userPermission=  json_decode($session->get('userPermission'));
 $permission=new \common\models\CommonCode();
 if ($permission->canAccess("user-deactive") || $userPermission->isSystemAdmin) {

  $menuItems[] =[
                            'label' => Yii::t('user', 'In Active'),
                            'url'   => ['/user/admin/block', 'id' => $user->id],
                            'visible' => !$user->isBlocked,
                            'linkOptions' => [
                                'class' => 'text-danger',
                                'data-method' => 'post',
                                'data-confirm' => Yii::t('user', 'Are you sure you want to inactive this user?'),
                            ],
                        ];
   $menuItems[] =[
                            ...
                            'linkOptions' => [
                                'class' => 'text-success',
                                'data-method' => 'post',
                                'data-confirm' => Yii::t('user', 'Are you sure you want to active this user?'),
                            ],
                        ];
 }
