...
<div class="grn-index">
	<div class=" col-md-12">  
		<a href="<?php echo Url::base(); ?>index.php?r=userrole%2Fcreate" style="<?php if(isset($access[0]['r_insert'])) { if($access[0]['r_insert']=='1') echo ''; else echo 'display: none;'; } else { echo 'display: none;'; } ?>"> 
			<button type="button" class="btn btn-grid btn-success btn-sm pull-right">Add New User Role </button>
		</a>
									...
									<tbody id="grn_details"> 
										...
										<tr> 
											...
											<td style="<?php if(isset($access[0]['r_edit'])) { if($access[0]['r_edit']=='1') echo ''; else echo 'display: none;'; } else { echo 'display: none;'; } ?>">
												<a href="<?php echo Url::base() .'index.php?r=userrole%2Fedit&id=' . $data[$i]['id']; ?>" >Edit </a>
											</td> 
