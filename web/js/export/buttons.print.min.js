(function(d) {
    ...
    i.ext.buttons.print = {
        ...
        action: function(a, b, h, e) {
            ...
            if(d("#company_name").text()!=''){
            	c = '<label style="text-align: center; display: block;">' + d("#company_name").text() + '</label>' + 
            		'<label style="text-align: center; display: block;">' + d("#account_name").text() + '</label>' + 
            		'<label style="float: left; display: block;">' + d("#from").text() + '</label>' + 
            		'<label style="float: right; display: block;">' + d("#to").text() + '</label>';
            } else {
            	c = "<h1>" + c + "</h1>";
            }
            ...
            g.document.close();
            var j = "<title>" + d("title").text() + "</title>";
            ...
            g.document.body.innerHTML = c + "<div>" + ("function" === typeof e.message ? e.message(b, h, e) : e.message) + "</div>" + a;
